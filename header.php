...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item">
                <a class="nav-link" href="http://localhost/phpcloudcampus/projet/home.php">Home</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="http://localhost/phpcloudcampus/projet/profil.php">Profile</a>
            </li>
            <?php if ($is_admin || $is_createur): ?>
                <li class="nav-item">
                <a class="nav-link" href="http://localhost/phpcloudcampus/projet/creation_article.php">Publier un article</a>
            </li>
            <?php endif; ?>
            <?php if ($is_admin): ?>
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="gestionDropdown">
                        <a class="dropdown-item" href="http://localhost/phpcloudcampus/projet/admin/gestion_article.php">Gestion des articles</a>
                        <a class="dropdown-item" href="http://localhost/phpcloudcampus/projet/admin/gestion_utilisateur.php">Gestion des utilisateurs</a>
                    </div>
                </li>
            <?php endif; ?>
        </ul>
